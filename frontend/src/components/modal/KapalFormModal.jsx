    ...
    if (activeTab === 'kapal') {
      return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2"><Label htmlFor="nama">Nama Kapal</Label><InputField name="nama" id="nama" value={formData.nama || ''} onChange={handleChange} required /></div>
          <div><Label htmlFor="jenis">Jenis Kapal</Label><Select name="jenis" id="jenis" value={formData.jenis || ''} onChange={handleChange} options={formattedJenisKapalOptions} required /></div>
          <div><Label htmlFor="bendera">Bendera</Label><InputField name="bendera" id="bendera" value={formData.bendera || ''} onChange={handleChange} required /></div>
          ...
          <div><Label htmlFor="nomorSelar">Nomor Selar</Label><InputField name="nomorSelar" id="nomorSelar" value={formData.nomorSelar || ''} onChange={handleChange} /></div>
          <div><Label htmlFor="tandaSelar">Tanda Selar</Label><InputField name="tandaSelar" id="tandaSelar" value={formData.tandaSelar || ''} onChange={handleChange} /></div>
          <div><Label htmlFor="nomorImo">Nomor IMO</Label><InputField name="nomorImo" id="nomorImo" value={formData.nomorImo || ''} onChange={handleChange} /></div>
          <div><Label htmlFor="callSign">Call Sign</Label><InputField name="callSign" id="callSign" value={formData.callSign || ''} onChange={handleChange} /></div>
        </div>
      );
    }
