...
const NahkodaFormModal = ({ onClose }) => {
      ...
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md mx-4">
        <form onSubmit={handleSubmit}>
          <div className="p-5 border-b">
            <h2 className="text-xl font-bold text-gray-800">Tambah Data Nahkoda</h2>
          </div>
          <div className="p-5 space-y-4">
            <div>
              <Label htmlFor="nama">Nama Nahkoda</Label>
              <InputField name="nama" id="nama" value={formData.nama} onChange={handleChange} placeholder="Contoh: Capt. Budi Santoso" required />
            </div>
          </div>
